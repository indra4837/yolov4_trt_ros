...
from utils.yolo_with_plugins_v4 import TrtYOLO
...
class yolov4(object):
	...
	self.model_path = rospy.get_param("/model_path", "/home/jetson-indra/test_ws/src/yolov4_trt/yolo/")
	...
	self.image_sub = rospy.Subscriber(
        ...
        self.overlay_pub = rospy.Publisher("/result/overlay", Image, queue_size=2)
	...
	# self.trt_yolo = TrtYOLO(self.model, (h, w), self.category_num)
	...
	# converts from ros_img to cv_img for processing
	    ...
	    if self.show_img:
	        ...
	        cv2.imshow("DETECTION RESULTS", cv_img)
	        cv2.waitKey(1)
